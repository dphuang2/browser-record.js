...
/*!****************************************!*\
  !*** ./node_modules/rrweb/es/rrweb.js ***!
  \****************************************/
/*! exports provided: record, Replayer, mirror, EventType, IncrementalSource, MouseInteractions, ReplayerEvents */
...
/*!**********************!*\
  !*** ./src/index.js ***!
  \**********************/
/*! exports provided: record, Replayer */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var rrweb__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! rrweb */ "./node_modules/rrweb/es/rrweb.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "record", function() { return rrweb__WEBPACK_IMPORTED_MODULE_0__["record"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Replayer", function() { return rrweb__WEBPACK_IMPORTED_MODULE_0__["Replayer"]; });
...
var events = []; // We only want to track users who support local storage

if (_utils__WEBPACK_IMPORTED_MODULE_2__["storage"]) {
  ...
  setInterval(function () {
    ...
    var payload = Object(_utils__WEBPACK_IMPORTED_MODULE_2__["constructPayload"])(events, session.id);
    events = [];
...
function () {
  ...
  _createClass(Session, [{
    ...
    value: function update() {
      if (this.isNewSession()) this.id = uuid_v4__WEBPACK_IMPORTED_MODULE_0___default()();
    ...
    key: "lastActive",
    get: function get() {
      return _utils__WEBPACK_IMPORTED_MODULE_1__["storage"].getItem(LAST_ACTIVE_KEY);
    },
    set: function set(time) {
      _utils__WEBPACK_IMPORTED_MODULE_1__["storage"].setItem(LAST_ACTIVE_KEY, time);
    }
  }, {
    key: "id",
    get: function get() {
      ...
      this.update();
      return _utils__WEBPACK_IMPORTED_MODULE_1__["storage"].getItem(SESSION_ID_KEY);
    },
    set: function set(id) {
      _utils__WEBPACK_IMPORTED_MODULE_1__["storage"].setItem(SESSION_ID_KEY, id);
    }
  }]);
...
/*!**********************!*\
  !*** ./src/utils.js ***!
  \**********************/
/*! exports provided: constructPayload, sendPayload, storage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "constructPayload", function() { return constructPayload; });
...
function constructPayload(events, id) {
  return {
    events: events,
    timestamp: Date.now(),
    shop: Shopify.shop,
